...
for (i in 1:6) {
  new_cells = calculate_grid(shape = prez_woj, learning_rate = 0.3, grid_type = "hexagonal", seed = i)
...
par(mfrow = c(2, 3), mar = c(0, 0, 2, 0))
for (i in 1:6) {
  new_cells = calculate_grid(shape = prez_pow, grid_type = "hexagonal", seed = i)
  plot(new_cells, main = paste("Seed", i, sep = " "))
}
...
par(mfrow = c(2, 3), mar = c(0, 0, 2, 0))
for (i in 1:6) {
  new_cells_pow = calculate_grid(shape = prez_pow, grid_type = "regular", seed = i)
  plot(new_cells_pow, main = paste("Seed", i, sep = " "))
}
