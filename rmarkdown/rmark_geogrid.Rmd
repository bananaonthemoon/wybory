...
rawplot_woj_duda = tm_shape(prez_woj) + 
  tm_fill("t1.duda", palette = paleta_blue, legend.show = FALSE) +
  tm_layout(frame = FALSE, legend.outside = FALSE)

rawplot_woj_frek = tm_shape(prez_woj) + 
  tm_fill("f1", palette = paleta_orange, legend.show = FALSE) +
  tm_layout(frame = FALSE, legend.outside = FALSE)
...
layout_pow_duda = tm_shape(resultreg_pow) + tm_fill("t1.duda", palette = paleta_blue) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))

layout_pow_frek = tm_shape(resultreg_pow) + tm_fill("f1", palette = paleta_orange) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))
