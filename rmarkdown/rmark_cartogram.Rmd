...
layout_woj_duda = tm_shape(prez_woj_dorling_duda) + 
  tm_polygons("t1_Andrzej.Sebastian.DUDA", style = "jenks", palette = paleta_red) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))

layout_woj_frek = tm_shape(prez_woj_dorling_frek) + 
  tm_polygons("t1_Frekwencja", style = "jenks", palette = paleta_green) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))
...
prez_pow_cont_frek = cartogram_cont(prez_pow, "t1_Frekwencja", 50, threshold = 0.1)
# Non-contiguous Area Cartogram
...
prez_wlkp_cont_frek = cartogram_cont(prez_wlkp, "t1_Frekwencja", 50, threshold = 0.1)
# Non-contiguous Area Cartogram
