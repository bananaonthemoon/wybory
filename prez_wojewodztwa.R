...
pres_woj = merge(woj1, obie_tury, by.x="kod2", by.y="t1_Group.1")

# obliczenie frekfencji oraz wyników kandydatów
pres_woj$"1_frekw" = with(pres_woj, t1_Liczba.głosów.ważnych / t1_Liczba.wyborców.uprawnionych.do.głosowania * 100)
pres_woj$"2_frekw" = with(pres_woj, t2_Liczba.głosów.ważnych / t2_Liczba.wyborców.uprawnionych.do.głosowania * 100)
pres_woj$f1.duda = with(pres_woj, t1_Andrzej.Sebastian.Duda / t1_Liczba.głosów.ważnych * 100)
pres_woj$f2.duda = with(pres_woj, t2_Andrzej.Sebastian.Duda / t2_Liczba.głosów.ważnych * 100)
pres_woj$f1.komo = with(pres_woj,  t1_Bronisław.Maria.Komorowski / t1_Liczba.głosów.ważnych * 100)
pres_woj$f2.komo = with(pres_woj,  t2_Bronisław.Maria.Komorowski / t2_Liczba.głosów.ważnych * 100)
pres_woj$f1.braun = with(pres_woj,  t1_Grzegorz.Michał.Braun / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.jarubas = with(pres_woj,  t1_Adam.Sebastian.Jarubas / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.korwin = with(pres_woj,  t1_Janusz.Ryszard.Korwin.Mikke / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.kowalski = with(pres_woj,  t1_Marian.Janusz.Kowalski / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.kukiz = with(pres_woj,  t1_Paweł.Piotr.Kukiz / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.ogorek = with(pres_woj,  t1_Magdalena.Agnieszka.Ogórek / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.palikot = with(pres_woj,  t1_Janusz.Marian.Palikot / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.tanajo = with(pres_woj,  t1_Paweł.Jan.Tanajno / t1_Liczba.głosów.ważnych * 100)
pres_woj$f1.Wilk = with(pres_woj,  t1_Jacek.Wilk / t1_Liczba.głosów.ważnych * 100)

write_sf(pres_woj, dsn = "pres_woj.gpkg")
