...
```{r geogrid_biblioteki, echo=FALSE}
...
```{r geogrid_wojewodztwa, results = 'hide'}
...
```{r geogrid_powiaty, results = 'hide'}
...
reglayout_pow_duda = tm_shape(resultreg_pow) + tm_polygons("t1.duda", style = "jenks", palette = get_brewer_pal("Reds")) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))

reglayout_pow_frek = tm_shape(resultreg_pow) + tm_polygons("f1", style = "jenks", palette = get_brewer_pal("Greens")) +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))

```

```{r geogrid_powiaty_wyniki}

tmap_arrange(rawplot_pow_duda, hexplot_pow_duda, regplot_pow_duda, reglayout_pow_duda, rawplot_pow_frek, hexplot_pow_frek, regplot_pow_frek, reglayout_pow_frek, nrow = 2)
...
### Na przykładzie województw
```{r cartogram_wojewodztwa, results='hide'}
...
```{r cartogram_powiaty, results='hide'}
