...
```{r geogrid_wojewodztwa, message=FALSE, warning=FALSE, results=FALSE}
...
```{r geogrid_powiaty, message=FALSE, warning=FALSE, results=FALSE}
...
### Na przykładzie województw
```{r cartogram_wojewodztwa, message=FALSE, warning=FALSE, results=FALSE}
...
```{r cartogram_powiaty, message=FALSE, warning=FALSE, results=FALSE}
