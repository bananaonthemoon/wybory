...
# Continuous Area Cartogram
prez_powiaty_cont <- cartogram_cont(prez_powiaty, "f1.duda", 3)

# Non-contiguous Area Cartogram
prez_powiaty_ncont <- cartogram_ncont(prez_powiaty, "f1.duda")

# Non-overlapping Circles Cartogram
prez_powiaty_dorling <- cartogram_dorling(prez_powiaty, "f1.duda")

# Plots
m1 <- tm_shape(prez_powiaty_cont) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE)

m2 <- tm_shape(prez_powiaty) + tm_borders() + 
  tm_shape(prez_powiaty_ncont) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE)

m3 <- tm_shape(prez_powiaty) + tm_borders() + 
  tm_shape(prez_powiaty_dorling) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE, legend.outside = TRUE)

ml <- tm_shape(prez_powiaty_dorling) + tm_polygons("f1.duda", style = "jenks") +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))
...
# Continuous Area Cartogram
prez_gminy_cont <- cartogram_cont(prez_gminy, "f1.duda", 3)

# Non-contiguous Area Cartogram
prez_gminy_ncont <- cartogram_ncont(prez_gminy, "f1.duda")

# Non-overlapping Circles Cartogram
prez_gminy_dorling <- cartogram_dorling(prez_gminy, "f1.duda")

# Plots
m1 <- tm_shape(prez_gminy_cont) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE)

m2 <- tm_shape(prez_gminy) + tm_borders() + 
  tm_shape(prez_gminy_ncont) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE)

m3 <- tm_shape(prez_gminy) + tm_borders() + 
  tm_shape(prez_gminy_dorling) + tm_polygons("f1.duda", style = "jenks", legend.show = FALSE) +
  tm_layout(frame = FALSE, legend.outside = TRUE)

ml <- tm_shape(prez_gminy_dorling) + tm_polygons("f1.duda", style = "jenks") +
  tm_layout(frame = FALSE, legend.only = TRUE, legend.position = c("center", "center"))
...
grid = getgrid(x = prez_powiaty, cellsize = 4000, var = "f1.duda")
...
grid = getgrid(x = prez_gminy, cellsize = 4000, var = "f1.duda")
